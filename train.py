...
import torchvision
from models.skanet import SkaNet
...
parser.add_argument('--initial', default='', type=str, metavar='PATH',
...
parser.add_argument('--weight-decay', type=float, default=0.04,
                    help='weight decay (default: 0.04)')
...
parser.add_argument('--decay-epochs', type=float, default=80, metavar='N',
...
def main():
    ...
    # dataset_train = TinyImageNet(args.data_dir, train=True)
    # dataset_eval = TinyImageNet(args.data_dir, train=False)
    ...
    # eval_h = data_config['input_size'][1] * 1.25
    # eval_input_size = (3, eval_h, eval_h)
    # #print(eval_input_size)
